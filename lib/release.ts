...
export const RELEASE = {
  ...
  tagUrl: "https://github.com/SetFodi/Andspace/releases/tag/v0.1.0-beta.2",
  issuesUrl: "https://github.com/SetFodi/Andspace/issues",
  dmgUrl:
    "https://github.com/SetFodi/Andspace/releases/download/v0.1.0-beta.2/AndSpace_0.1.0-beta.2_aarch64.dmg",
} as const;
